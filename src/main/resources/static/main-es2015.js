...
let TasksAddComponent = class TasksAddComponent {
    ...
    onTaskAdd(event) {
        let task = new _task_model__WEBPACK_IMPORTED_MODULE_3__["Task"](event.target.value, false, new Date().toLocaleDateString());
...
module.exports = __webpack_require__(/*! C:\Users\bpipi\repositories\tasks\src\main\resources\frontend\src\main.ts */"./src/main.ts");
